// src/components/game/shop/ItemDetailsDialog.tsx
...
const ItemDetailsDialog: React.FC<ItemDetailsDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-lg shadow-xl">
